...
peso_peixes= float(input("Informe o peso do peixe: "))
excesso = peso_peixes - 50
multa = 4*excesso
if peso_peixes >=50:
    print("O peso excedeu o limite em",excesso, "quilos, voce terá que pagar uma multa de R$",multa)
else:
    print("Não a necessidade de pagar multa")